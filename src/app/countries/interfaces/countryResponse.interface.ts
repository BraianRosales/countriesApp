...
export class Convert {
  public static toGifsSearchResponse(json: string): CountryResponse[] {
    return cast(JSON.parse(json), a(r('CountryResponse')));
  }

  public static gifsSearchResponseToJson(value: CountryResponse[]): string {
...
const typeMap: any = {
  ...
  Currencies: o([{ json: 'BRL', js: 'BRL', typ: r('Brl') }], false),
  Brl: o(
    [
  ...
  Gini: o([{ json: '2019', js: '2019', typ: 3.14 }], false),
  Idd: o(
    [
  ...
  Languages: o([{ json: 'por', js: 'por', typ: '' }], false),
  Maps: o(
    [
  ...
  NativeName: o([{ json: 'por', js: 'por', typ: r('Translation') }], false),
  Translation: o(
    [
      { json: 'official', js: 'official', typ: '' },
      { json: 'common', js: 'common', typ: '' },
